...
jQuery(function ($) {
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('Graphic Designer').pauseFor(2000).deleteAll()
            .typeString('Video Producer').pauseFor(2000).deleteAll()
            .typeString('Web Designer').pauseFor(2000).deleteAll()
            .typeString('Gamer').pauseFor(1500).start();
    }
